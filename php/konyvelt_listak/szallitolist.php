...
SUM(
    CASE
        WHEN k.kovetel LIKE '45%' THEN k.osszeg
        WHEN k.tartozik LIKE '45%' THEN -k.osszeg
        ELSE k.osszeg
    END
) AS adjusted_osszeg,
SUM(
    ...
    <div id="contentContainer" class="suppinvoice container mx-auto m-5 shadow rounded" style="background-color: rgba(225, 230, 224);">
        <div class="pt-2">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active text-secondary border-bottom-0 border-secondary" aria-current="page" href="szallitolist.php">Szállító</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row pt-3">
            ...
            <div class="col mx-auto text-center pt-3 mt-3 mb-4">
                <h3>Rögzített szállítói számlák</h3>
            </div>
            <div class="col-1"></div>
        </div>
        <div class="p-4">
            <div class="row">
                    ...
                    <div class="row w-100">
                        <div class="col">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="szallito_nev" onkeyup='kereses("szallito_nev","szallitoszamlak")' placeholder="Név alapján...">
                            </div>
                        </div>
                        <div class="col">
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-magnifying-glass"></i></span>
                                <input type="text" class="form-control" id="szallito_szamla" onkeyup='kereses("szallito_szamla","szallitoszamlak")' placeholder="Számlaszám alapján...">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row listainput">
                    <div id="columnChange" class="mx-auto">
                        <div class="row">
                            <table class="rounded text-dark" style="background-color: secondary; color:white; font-size: 14px" id="szallitoszamlak">
                                ...
                                <tbody class="text-center">
                                    <?php foreach ($konyveltszamlak as $szamla) : ?>
                                        <tr style="border-top: 1px solid rgb(200, 200, 200)">
                                            ...
                                            <td>
                                                <button class="btn btn-outline-dark" style="border:none;" id="szallito_mod_<?= $szamla["szamlaszam"] ?>" onclick='szamlamodositas(this.id)'><i class="fa-regular fa-pen-to-square"></i></button>
                                                <button class="btn btn-outline-dark" style="border:none;" id="szallito_del_<?= $szamla["szamlaszam"] ?>" onclick='szamlamodositas(this.id)'><i class="fa-regular fa-trash-can"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
