    ...
    <div id="" class="container mx-auto m-5 shadow" style="background-color: rgba(225, 230, 224)">
        <div class="row pb-4">
            ...
            <div class="col-10 mx-auto text-center pt-3 mt-3">
                <h3>Eredménykimutatás összköltség eljárással</h3>
            </div>
            <div class="col-1"></div>
        </div>
        <div class="row pb-4 text-center">
            <form action="" id="eredmenykimutatas">
                <input class="p-1 ps-2" type="text" placeholder="évszám" name="ev" id="ev">
                <div class="btn btn-dark m-2" onclick="getEredmenykimutatas(); showPrintButton();"><i class="fa-regular fa-circle-down"></i> Lekérés</div>
            </form>
        </div>
        <div class="mx-auto p-4" id="eredmenykimutatas_table"></div>
        <div class="d-grid gap-2 d-md-flex justify-content-md-end pb-3">
            <button onclick="printTable('eredmenykimutatas_table')" class="btn btn-outline-success" id="printButton" style="display: none;"><i class="fa-solid fa-print"></i> Nyomtatás</button>
        </div>
    </div>
    <script>
