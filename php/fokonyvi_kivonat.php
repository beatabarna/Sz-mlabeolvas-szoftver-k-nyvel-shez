...
<body>
    ...
    <div id="" class="container mx-auto m-5 shadow" style="background-color: rgba(225, 230, 224);max-width:1000px;">
        <div class="row pb-4">
            ...
            <div class="col-10 mx-auto text-center pt-3 mt-3">
                <h3>Főkönyvi kivonat</h3>
            </div>
            <div class="col-1"></div>
        </div>
        <div class="row pb-4 text-center">
            <form action="" id="fokonyvi_kivonat">
                <input class="p-1 ps-2" type="text" placeholder="évszám" name="ev" id="ev">
                <div class="btn btn-dark m-2" onclick="getFokonyviKivonat(); showPrintButton();"><i class="fa-regular fa-circle-down"></i> Lekérés</div>
            </form>
        </div>
        <div class="d-grid gap-2 d-md-flex justify-content-md-end pb-3">
            <button onclick="printTable('fokonyvi_kivonat_table')" class="btn btn-outline-success" id="printButton" style="display: none;"><i class="fa-solid fa-print"></i> Nyomtatás</button>
        </div>
        <div class="row listainput">
            <div id="columnChange" class="mx-auto">
                <div class="row">
                    <div class="mx-auto p-4" id="fokonyvi_kivonat_table"></div>
                </div>
            </div>
        </div>
    </div>
